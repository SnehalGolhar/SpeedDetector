package app.indvidual.cmpe235.speeddetector;
...
public class MainActivity extends ActionBarActivity implements LocationListener, GpsStatus.Listener {
    ...
    private DataProvider.onGpsServiceUpdate onGpsServiceUpdate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data = new DataProvider(onGpsServiceUpdate);
        ...
        onGpsServiceUpdate = new DataProvider.onGpsServiceUpdate() {
            @Override
            public void update() {
    ...
    protected void onResume() {
        ...
        if (!data.isRunning()) {
            ...
            data = gson.fromJson(json, DataProvider.class);
        }
        if (data == null) {
            data = new DataProvider(onGpsServiceUpdate);
        } else {
